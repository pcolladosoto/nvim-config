-- Vim Illuminate configuration. Be sure to check the project page
-- over at https://github.com/RRethy/vim-illuminate.
local status_ok, illuminate = pcall(require, "illuminate")
if not status_ok then
	return
end

vim.pretty_print(illuminate)

-- Default config pulled from https://github.com/RRethy/vim-illuminate/blob/master/README.md
illuminate.configure({
	...
	-- Modes not to illuminate, this overrides modes_allowlist.
